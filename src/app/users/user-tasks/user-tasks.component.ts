...
export const resolveTitle: ResolveFn<string> = (activatedRoute: ActivatedRouteSnapshot, state: RouterStateSnapshot) => {
  return resolveUserName(activatedRoute, state) + '\'s Tasks';
};
